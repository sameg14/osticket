...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?1faad22">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?1faad22">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?1faad22"></script>
    <script type="text/javascript" src="js/tips.js?1faad22"></script>
    <script type="text/javascript" src="js/setup.js?1faad22"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
