...
<head>
    ...
    <script type="text/javascript" src="./js/scp.js?1faad22"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/jquery.pjax.js?1faad22"></script>
    ...
    <script type="text/javascript" src="./js/tips.js?1faad22"></script>
    ...
    <script type="text/javascript" src="./js/bootstrap-typeahead.js?1faad22"></script>
    <link rel="stylesheet" href="<?php echo ROOT_PATH ?>css/thread.css?1faad22" media="all">
    <link rel="stylesheet" href="./css/scp.css?1faad22" media="all">
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/redactor.css?1faad22" media="screen">
    <link rel="stylesheet" href="./css/typeahead.css?1faad22" media="screen">
    ...
    <!--[if IE 7]>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/font-awesome-ie7.min.css?1faad22">
    <![endif]-->
    <link type="text/css" rel="stylesheet" href="./css/dropdown.css?1faad22">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/loadingbar.css?1faad22"/>
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/rtl.css?1faad22"/>
    <script type="text/javascript" src="./js/jquery.dropdown.js?1faad22"></script>
